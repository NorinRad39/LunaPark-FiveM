...
namespace Client.net.LunaPark
{
    ...
    _descriptionText.Position.X + 400f
        ...
        // Ajoutez cette méthode pour utiliser l'événement OnProgressSelect
        protected virtual void ProgressSelect(UIMenuProgressItem sender, int newindex)
        {
            this.OnProgressSelect?.Invoke(this, sender, newindex);
        }
    }
}
